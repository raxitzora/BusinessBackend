...
async getBusinessById(id, userId) {
    ...
    // ================================
async getBusinesses(userId, page = 1, limit = 20) {
...
// Save Lead
// ================================
async saveLead(userId, businessId) {
...
// Check Saved Lead
// ================================
async isLeadSaved(userId, businessId) {
...
// Remove Saved Lead
// ================================
async removeSavedLead(userId, businessId) {
    ...
    async enrichBusinessesInBackground(businesses) {
...
// ================================
async getSearchHistoryCount(userId) {
